/*
Nombres: Iveth Castro y Remmy Arevalo
Fecha: 26/09/25
Descripcion: Este programa usa un sistema sencillo para gestionar un unico producto en una tienda, permitiendo registrar los datos  
basicos del producto y luego ofreciendo un menu de opciones para vender unidades, restablecer stock y consultar la informacion actualizada
del producto. El programa se mantiene en ejecuccion hasta que el usario decida salir
*/
#include <stdio.h>
